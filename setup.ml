...
(* OASIS_START *)
(* DO NOT EDIT (digest: 01bd9a757c3a67e7f211b3b9263ee0b4) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$btree_test", []))];
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "Persistent b-tree over Mirage Blkif (initially via Baardskeerder)";
          description = None;
          categories = [];
            ...
            [
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("mirage-baardskeerder", None);
                           FindlibPackage
                             ("mirage-baardskeerder.mirage", None);
                      ...
                      },
                   {
                      ...
                      lib_findlib_name = Some "ocaml-btree";
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "ocaml_btree";
                           FindlibPackage ("unix-simple-blkdev", None);
                           FindlibPackage ("mirage", None);
                           FindlibPackage ("mirage-baardskeerder", None);
                           FindlibPackage
                             ("mirage-baardskeerder.mirage", None)
                   ...
                   {exec_custom = true; exec_main_is = "btree_test.ml"; });
               Test
                 ({
                     cs_name = "btree_test";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\198\198\190r\190o\028\030=\212_\023\006j\165\162";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
